...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(`${API}/api/auth/logout`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${API}/api/auth/admin/user/${id}`);
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${API}/api/auth/admin/user/${id}`);
